...
void SoundEffects::playEatingCherry() {
    play(bufferEatingCherry);
}
void SoundEffects::playEatingGhost() {
    play(bufferEatingGhost);
}
void SoundEffects::playExtraLife() {
    play(bufferExtraLife);
}
void SoundEffects::playIntermission() {
    play(bufferIntermission);
}

void SoundEffects::playOpeningSong() {
    play(bufferOpeningSong);
}
void SoundEffects::playSiren() {
    play(bufferSiren);
}
void SoundEffects::playWakaWaka() {
    play(bufferWakaWaka);
}
