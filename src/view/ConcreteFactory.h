...
public:
     ...
     */
    shared_ptr<Ghost> createGhost(const GhostType type,
                                  const std::tuple<double, double, double, double>& position) override;
     ...
     */
    shared_ptr<PacMan> createPacMan(const std::tuple<double, double, double, double>& position) override;
     ...
     */
    shared_ptr<Wall> createWall(const std::tuple<double, double, double, double>& position) override;
     ...
     */
    shared_ptr<Coin> createCoin(const std::tuple<double, double, double, double>& position) override;
     ...
     */
    shared_ptr<Fruit> createFruit(const std::tuple<double, double, double, double>& position) override;
