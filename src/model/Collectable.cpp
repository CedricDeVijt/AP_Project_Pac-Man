...
Fruit::Fruit(const std::tuple<double, double, double, double>& position, int alternative)
    : Collectable(position), alternative(alternative) {}

int Fruit::getAlternative() const { return alternative; }
